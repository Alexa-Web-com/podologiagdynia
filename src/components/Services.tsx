  ...
  const services = [
    {
      ...
      description:
        "Profesjonalne usuwanie zmian skórnych z wykorzystaniem specjalistycznego sprzętu.",
    },
    {
      icon: <Footprints className="w-10 h-10 text-primary" />,
      title: "Terapia wrastających paznokci",
      description:
        "Skuteczne metody terapii, w tym klamry ortonyksyjne i odpowiednie opracowanie paznokci.",
    },
    {
      icon: <Sparkles className="w-10 h-10 text-primary" />,
      title: "Rekonstrukcja paznokci",
      description:
        "Odbudowa uszkodzonych paznokci za pomocą specjalnych żelów i żywic.",
    },
    {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Oferuję szeroki zakres usług podologicznych dostosowanych do
