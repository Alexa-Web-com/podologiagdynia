...
import treatment2 from "@/assets/treatment-2.png";
import treatment3 from "@/assets/treatment-3.png";
import treatment4 from "@/assets/treatment-4.jpg";
import treatment5 from "@/assets/treatment-5.png";
import treatment6 from "@/assets/treatment-6.png";
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
              {categories[activeCategory].images.map((image, index) => (
                ...
                >
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-foreground/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
